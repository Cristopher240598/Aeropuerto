 ...
 */
public class VentanaModificaDestino extends javax.swing.JFrame
{

    private Nodo n2;
    public static Nodo arrDes[];
    public static String sDes[] = new String[2];

    /**
     * Creates new form VentanaAltasAeropuerto
     */
    public VentanaModificaDestino()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        eliminar.setBounds(220, 250, 100, 23);
        ...
        letreroEliminarN2.setText("Destino:");
    ...
    {//GEN-HEADEREND:event_eliminarActionPerformed
        ...
        try
        {
            sDes[0] = (String) elementosNivel1.getSelectedItem();
            sDes[1] = (String) elementosNivel2.getSelectedItem();
            arrDes = ManipulaMultista.elimina((String) elementosNivel2.getSelectedItem(), VentanaPrincipal.r, 0, sDes);
            VentanaPrincipal.r = arrDes[1];
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VentanaModificaDestino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
