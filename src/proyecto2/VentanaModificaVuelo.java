 ...
 */
public class VentanaModificaVuelo extends javax.swing.JFrame
{

    Nodo n2, n3, n4;
    public static Nodo arrVue[] = null;
    public static String sVue[] = new String[4];

    /**
     * Creates new form VentanaAltasAeropuerto
     */
    public VentanaModificaVuelo()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        letreroEliminarN4.setText("Vuelo:");
        ...
        modificar.setBounds(220, 440, 100, 23);
    ...
    {//GEN-HEADEREND:event_modificarActionPerformed
        ...
        try
        {
            sVue[0] = (String) elementosNivel1.getSelectedItem();
            sVue[1] = (String) elementosNivel2.getSelectedItem();
            sVue[2] = (String) elementosNivel3.getSelectedItem();
            sVue[3] = (String) elementosNivel4.getSelectedItem();
            arrVue = ManipulaMultista.elimina((String) elementosNivel4.getSelectedItem(), VentanaPrincipal.r, 0, sVue);
            VentanaPrincipal.r = arrVue[1];
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VentanaModificaVuelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
